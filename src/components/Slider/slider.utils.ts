...
export const SLIDER_IMG_DATA = [
  ...
  { id: 8, src: assetPaths.slider.haduri7, title: '큐티샷ㅋ' },
  { id: 9, src: assetPaths.slider.haduri8, title: '지켜줄게' },
  { id: 10, src: assetPaths.slider.haduri9, title: '이쁘니^^' },
  { id: 11, src: assetPaths.slider.haduri10, title: '연락해' },
];
